...
import { 
  ...
  Gamepad2, TrendingUp, X, Check, Minus
        ...
        <View style={styles.goalsSection}>
          ...
          {goals.length === 0 ? (
            <View style={styles.emptyState}>
              <View style={styles.hollowRing}>
                <Circle size={80} color="rgba(255,255,255,0.2)" strokeWidth={2} />
              </View>
              <Text style={styles.emptyTitle}>Let's start this week</Text>
